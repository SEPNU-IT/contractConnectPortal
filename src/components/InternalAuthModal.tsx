...
import { X, Mail, Shield, ArrowRight, Lock, AlertCircle } from 'lucide-react';
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className={`w-full bg-white/95 border-2 rounded-xl px-4 py-3 text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-rose-400/50 focus:border-rose-400 backdrop-blur-sm font-medium transition-all duration-200 ${
                    error 
                      ? 'border-red-400 bg-red-50/95 focus:border-red-400 focus:ring-red-400/50' 
                ...
                />
                <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-rose-500/5 via-sky-500/5 to-pink-500/5 pointer-events-none"></div>
              </div>
              
              {/* Error Message */}
              {error && (
                <div className="flex items-center mt-2 text-red-200 text-sm bg-red-500/20 rounded-lg px-3 py-2 border border-red-400/30">
